...
<body>
    ...
    <div id="mainHolder" style="overflow: auto; max-height: 500px;">
        ...
        if (isset($_POST['submit'])) {
            ...
            $stid = oci_parse($conn, "INSERT INTO COURSES (COURSE_ID, COURSE_NAME, COURSE_REQUIREMENT) VALUES (:courseId, :courseName, :courseRequirement)");
